 ...
 */
blogRouter.get("/getAll", blog_1.getAll);
/**
 * @swagger
 * /blog/find/{id}:
 *   get:
 ...
 *         description: Internal server error
 */
blogRouter.get("/find/:id", blog_1.findBlog);
blogRouter.get("/findImg/:id", blog_1.findImg);
/**
 * @swagger
 * /blog/featured:
 *   get:
 ...
 *         description: Internal server error
 */
blogRouter.get("/featured", blog_1.featuredBlog);
/**
 * @swagger
 * /blog/updateViews/{id}:
 *   get:
 ...
 *         description: Internal server error
 */
blogRouter.get("/updateViews/:id", blog_1.updateBlogViews);
/**
 * @swagger
 * /blog:
 *   post:
 ...
 *         description: Internal server error
 */
blogRouter.post("/", verify_1.default, blog_1.createBlog);
blogRouter.post("/uploadImage", blog_1.uploadImage);
/**
 * @swagger
 * /blog/updateBlog/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
blogRouter.put("/updateBlog/:id", verify_1.default, blog_1.updateBlog);
/**
 * @swagger
 * /blog/likeBlog/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
blogRouter.put("/likeBlog/:id", verify_1.default, blog_1.likeBlog);
/**
 * @swagger
 * /blog/{id}:
 *   PUT:
 ...
 *         description: Internal server error
 */
blogRouter.put("/deleteBlog/:id", verify_1.default, blog_1.deleteBlog);
